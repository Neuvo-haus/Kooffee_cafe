...
const Reservations = () => {
  return (
    <div className="w-full min-w-0 bg-[rgba(245,240,232,1)] pb-20 pt-24 md:pt-32">
      <section className="flex w-full justify-center px-6 md:px-0">
        <div className="grid w-full max-w-6xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="flex flex-col gap-6">
            ...
            <div className="grid min-w-0 grid-cols-1 gap-3 font-dmsans text-sm text-[rgba(100,96,88,1)] sm:grid-cols-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="min-w-0 break-words rounded-2xl border border-[rgba(226,221,213,0.9)] p-4 transition hover:border-[#C4A882]"
              >
          ...
          <div className="h-[340px] overflow-hidden rounded-3xl border border-[rgba(226,221,213,0.9)] shadow-2xl sm:h-[420px] lg:h-[620px]">
            <img
